...
import net.dispider.dispidermod.entity.custom.projectile.SlimeProjectileEntity;
...
public class SlimePokeballItem extends Item {


    public SlimePokeballItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pLevel.isClientSide) {
            SlimeProjectileEntity snowball = new SlimeProjectileEntity(pPlayer,pLevel);
    ...
    public void appendHoverText(ItemStack pStack, TooltipContext pContext, List<Component> pTooltipComponents, TooltipFlag pTooltipFlag) {
        ...
        pTooltipComponents.add(Component.translatable("Mob stored: Slime"));
