...
public class GronEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3,new TemptGoal(this,1.25, stack -> stack.is(ModItems.Soul.get()),false));
    ...
    public static AttributeSupplier.Builder createAttributes(){
        return Animal.createLivingAttributes().add(Attributes.MAX_HEALTH,50D).add(Attributes.MOVEMENT_SPEED,0.75D).add(Attributes.FOLLOW_RANGE,240D);
    }


    @Override
    public boolean isFood(ItemStack pStack) {
        return pStack.is(ModItems.Soul.get());
    }
